...
public class IntConverter {
	...
	/**
	 * Converts an integer value into a reversed array of integers
	 *
	 * @param value
	 * @return
	 */
	public static int[] split(int value) {
		...
		final char[] charArray = valueString.toCharArray();

		// convert the values to int and reverse (makes the value more readable
		// by the consumer)
